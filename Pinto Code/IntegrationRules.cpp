...
void lgwt(int NumPoints, double a, double b, double x[],
        double w[]) 
{
 
    cgqf ( NumPoints, 1, 0.0 , 0.0 ,  a,  b, 
   x,  w ); 
...
void laguerre(int NumPoints, double a, double b, double x[],
        double w[]) 
{
 
    cgqf ( NumPoints, 5, 0.0 , 0.0 ,  a,  b, 
   x,  w ); 
