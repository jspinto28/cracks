...
Let $m \in \IN$, $m\geq1$, and $K \subset \rgeo{m}$ a compact set, then 
\begin{enumerate}
\item 
\begin{align*}
...
\end{align*} 
are both holomorphic, uniformly bounded,  and we also have \todo{check the proof this last part->}
\begin{align*}
...
\begin{align*}
|\widehat{f}_{n,l}| \lesssim \|f\|_{\cmspace{m}{\iinterv}{\IC}}  \min ( n^{-m}, l^{-m}),\\
|\widecheck{f}_{n,l}| \lesssim \|f\|_{\cmspace{m}{\iinterv}{\IC}}  \min ( n^{-m}, l^{-m}),
\end{align*}
